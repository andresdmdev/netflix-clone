    ...
    <>
      <Slide 
        ...
        className={`transition ease-in-out delay-200 duration-300 
          hover:z-200 sm:hover:scale-125 sm:first:hover:translate-x-8 
        ...
        >
          <div 
            ...
            >
              <SliderImgWrapper image={data.backdrop_path} active={mouseOver} title={data.title} id={data.id} type={data.media_type} />
              {
