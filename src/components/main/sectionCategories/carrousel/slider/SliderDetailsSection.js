...
export default function SliderDetailsSection({ data }){
  ...
  return (
    <div className={`hover:z-300 absolute -bottom-20 sm:py-1.5 sm:px-2 lg:py-2 lg:px-3 bg-gray-tones-450 w-full rounded-b h-20 transition ease-in-out duration-500`}>
